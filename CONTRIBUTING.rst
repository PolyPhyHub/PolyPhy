...
If you experience bugs or general issues with ``polyphy``, please have a look
...
You can help improve ``polyphy`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``polyphy`` documentation uses Sphinx_ as its main documentation compiler.
...
that any documentation update is done in the same way was a code contribution.
   ...
   .. tip::
      ...
      propose changes in ``polyphy``'s files. While this mechanism can
