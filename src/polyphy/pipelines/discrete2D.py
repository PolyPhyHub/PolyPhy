...
from core.discrete2D import PPInputData_2DDiscrete, PPInternalData_2DDiscrete, PPSimulation_2DDiscrete, PPPostSimulation_2DDiscrete
...
class PolyPhy_2DDiscrete(PolyPhy):
    ...
    def start_simulation(self):
        PPSimulation_2DDiscrete(self.ppInternalData, self.ppConfig, self.batch_mode, self.num_iterations)
